...
export class ChangeDataModal extends View<IPropsChangeDataModal, IChildrenChangeDataModal> {
  ...
  initChildren(): void {
    this.children[EChangeDataModalChildren.EmailInput] = new Input({
    ...
    this.children[EChangeDataModalChildren.LoginInput] = new Input({
    ...
    this.children[EChangeDataModalChildren.FirstNameInput] = new Input({
    ...
    this.children[EChangeDataModalChildren.SecondNameInput] = new Input({
    ...
    this.children[EChangeDataModalChildren.DisplayNameInput] = new Input({
    ...
    this.children[EChangeDataModalChildren.PhoneInput] = new Input({
    ...
    this.children[EChangeDataModalChildren.SubmitBtn] = new Button({
      name: 'Change data',
      color: 'primary',
      size: 'l',
    ...
    this.children[EChangeDataModalChildren.LinkBtn] = new Button({
      name: 'Cancel',
      color: 'secondary',
      size: 'l',
